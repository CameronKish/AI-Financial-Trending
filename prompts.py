...
def get_pnl_analysis_prompt(account_name, account_id, current_period, current_amount_str, previous_period, previous_amount_str, formatted_je_data, is_outlier_context=""):
    ...
    **Your Task:**
    1. Briefly summarize the main activities or types of transactions recorded in the provided journal entries for {current_period}.
    ...
    4. Keep your explanation concise and focused solely on the provided JE details. Do not invent information.
    """
